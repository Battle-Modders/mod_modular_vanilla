...
### `cascade_skill` and `hail_skill` missing isAlive check in `onUse`
Bug report: https://steamcommunity.com/app/365360/discussions/1/684112727828878904/

The missing isAlive check can cause a crash if the user dies to a Riposte from the target during the scheduled attacks.
