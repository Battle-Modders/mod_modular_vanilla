...
# Vanilla Fixes
Modular Vanilla includes fixes for various vanilla bugs and issues. The complete list is available [here](https://github.com/Battle-Modders/mod_modular_vanilla/wiki/Vanilla-Fixes).
